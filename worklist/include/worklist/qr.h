...
/*
 * file:	Copied from qr.h and modified
 ...
 */
extern void      WriteToListFile        ( int A_messageID, const char* A_outFileName );
extern void      ValMessage             ( int A_messageID, const char* A_name);
